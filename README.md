...
│   ├── MyFurdi_リリースプラン_フェーズ別要件.md (NEW)
│   ├── MyFurdi_デザイン更新項目リスト.md (NEW)
│   └── MyFurdi_運用プラン.md (NEW)
│
...
4. **MyFurdi_リリースプラン_フェーズ別要件.md** (NEW)
   - フェーズ1（3月上旬リリース）とフェーズ2の要件整理
   - デザイン更新項目と運用プランの分類
   - 議事録からまとめた修正要望の体系化

5. **MyFurdi_デザイン更新項目リスト.md** (NEW)
   - モックアプリとワイヤーフレームの更新計画
   - フェーズ別の画面更新項目リスト
   - 新規画面の作成計画

6. **MyFurdi_運用プラン.md** (NEW)
   - サーバー側基盤の構築計画
   - ポイント・バッジ管理システム設計
   - 連携API・認証基盤の実装仕様
   - 監視・分析体制の整備計画
...
| 2025-10-09 | 1.2.0 | リリースプラン・デザイン更新項目リスト・運用プラン追加 |
